...
class ChatMessage(Base):
    ...
    feedback_category: Mapped[str | None] = mapped_column(String(50))
    feedback_resolved: Mapped[bool | None] = mapped_column(Boolean)
    feedback_resolved_by: Mapped[str | None] = mapped_column(UUID(as_uuid=False))
