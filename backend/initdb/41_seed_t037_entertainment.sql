...
SELECT '35229d3c-8770-566b-9b8b-8086184d44bf', d.id, 'Sun World Núi Bà Đen (Cáp treo & khu vui chơi)', 'entertainment', 'Khu phố Ninh Phú, phường Ninh Sơn, TP. Tây Ninh, tỉnh Tây Ninh (cách trung tâm ~11km)', NULL, NULL,
       'Cáp treo tuyến Chùa Hang: T2–T6 7:00–18:00, T7 7:00–19:15, CN 6:00–19:15; tuyến Vân Sơn theo khung giờ — xác nhận trước khi đến', 'Quần thể du lịch trên núi Bà Đen (nóc nhà Nam Bộ) với hệ thống cáp treo hiện đại (tuyến Vân Sơn, Chùa Hang, Tâm An), khu tâm linh trên đỉnh, vườn hoa và nhiều trải nghiệm vui chơi, check-in biển mây.', 'Lên đỉnh bằng tuyến Vân Sơn để ngắm tượng Phật Bà và biển mây; tuyến Chùa Hang để viếng chùa Bà. Đi sáng sớm tránh nắng.', NULL, TRUE, 'vietnamtourism.gov.vn; Sở Văn hóa Thể thao và Du lịch Tây Ninh; T-037: Sun World Núi Bà Đen — sunworld.vn & Traveloka (2025)'
...
SELECT '0fed698e-79fc-5d2a-9368-a36360dae79a', d.id, 'Khu du lịch Hồ Mây Park (Cáp treo Hồ Mây)', 'amusement_park', 'Số 1A Trần Phú, Phường 1, TP. Vũng Tàu, Bà Rịa — Vũng Tàu', NULL, NULL,
       'Cáp treo khoảng 8:00–23:00; khu trò chơi & công viên nước 8:00–18:00 — xác nhận lịch trước khi đến', 'Khu giải trí trên đỉnh Núi Lớn đi bằng cáp treo, có hơn 70 trò chơi, công viên nước trên núi (đường trượt từ độ cao ~10m), rạp phim 7D và chương trình nhạc nước, view toàn cảnh biển Vũng Tàu.', 'Đi T2–T5 thường được giảm ~20% giá vé; lên đỉnh ngắm hoàng hôn trên biển.', NULL, TRUE, 'Sở Du lịch TP.HCM; Sở Du lịch tỉnh Bà Rịa - Vũng Tàu; T-037: Hồ Mây Park — homaypark.com & Traveloka (2025)'
...
SELECT 'd5cbbe39-abb4-5628-ba59-43664bf5d728', d.id, 'Khu du lịch H''Mong Village', 'entertainment', 'Khu Tráng Kìm, xã Đông Hà, huyện Quản Bạ, Hà Giang (trên QL4C đi cao nguyên đá Đồng Văn, cách TP. Hà Giang ~50km)', NULL, NULL,
       'Theo lịch khu nghỉ dưỡng — xác nhận trước khi đến', 'Khu du lịch cấp tỉnh đầu tiên của Hà Giang theo phong cách bản người Mông, có bungalow trình tường đất, bể bơi vô cực, sân bóng, sân tennis, Sky Bar ngoài trời và trải nghiệm văn hóa vùng cao.', 'Dừng chân trên đường lên Đồng Văn; bể bơi vô cực và Sky Bar ngắm núi rất đẹp.', NULL, TRUE, 'T-037: H''Mong Village Resort — hmongvillage.com.vn & Booking.com (2025)'
